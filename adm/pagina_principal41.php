...
<div class="jumbotron" style="border-bottom:3px solid rgba(216,211,211,0.90);margin-top:-20px;background-color:<?php echo $corTopo; ?>;padding:0px;">
...
<div style="border-top:3px solid <?php echo $corTopo ?>;width:auto;height:105px;background-color:<?php echo $corBase ?>;bottom:0px;position:relative;margin-bottom:0px">
	<div class="content center" style="border:1px #000 DASHED">
	<a  class="btn btn-default btn-smal" href="#">one</a>
	<a  class="btn btn-default" href="#">dois</a>
	<a  class="btn btn-default" href="#">tres</a>
	<a  class="btn btn-default" href="#">quatro</a>
