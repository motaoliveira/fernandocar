...
print_r ($_FILES);
*/
	$selectAtuacao = "SELECT * FROM `projeto`";
...
mkdir("../projeto/$novaPasta/", 0777, true);
mkdir("../projeto/$novaPasta/img", 0777, true);
$dir_upload = "../projeto/$novaPasta/img/";
$max_size = 2000000;
$titulo = $_POST['titulo'];
...
if(isset($_POST)==1){
	mysql_query("INSERT INTO `projeto` (`id`, `img`, `titulo`, `descri`, `texto`, `data`, `hora`) VALUES ('$novaPasta', '$name', '$titulo', '$descricao', '$mensage', '$data', '$hora');");
