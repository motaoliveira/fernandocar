  ...
  content_css: '//www.tinymce.com/css/codepen.min.css'
	...
	$(document).ready(function(){
		 $(".dlt").click(function()
			{
			var id = $(this).attr('id');
			$.post("delete_clientez.php", { id:id },function() {
			 });
			location.reload();
		});
		 $(".edt").click(function(){
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">Parceria</li>
	...
	<div class="container"  >
		<div class="row">	
			<div class="card w-100">
						<h3 class="card-header">Retirar Parceria</h3>
				<div class="card-block">
				
					<div class="row" >
						<?php 
							$categori ="SELECT * FROM `clientez` ORDER BY `clientez`.`id` DESC";
						...
						<div class="col-3" style="text-align:center">
							<img class="img-thumbnail" src="../clientez/<?php echo $imgpa; ?>"  />
