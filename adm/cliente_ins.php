...
include("globais.php");
	...
	$selectAtuacao = "SELECT * FROM `clientez`";
...
if(isset($_POST)==1){
	...
	mysql_query("INSERT INTO `clientez` (`id`, `img`, `titulo`, `descri`, `texto`, `data`, `hora`) VALUES ('$novaPasta', '$novonome', '$titulo', '$descricao', '$mensage', '$data', '$hora');");
