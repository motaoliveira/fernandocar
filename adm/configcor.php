					...
					<div class="card-heading"><h3>Alterar cor do Topo</h3></div>
						<div class="card-block">
							<form role=group >
								...
								<div class="col-12">
									<div class="form-group">
									<button class="btn btn-primary" id="insCor">
									<span class="glyphicon glyphicon-ok"></span> Aplicar
									</button>
									</div>
								</div>	
						  ...
						  <div class="card-block">
							...
							<p class="card-text">Altere a cor do topo do seu administrador de conteúdo.</p>
								...
								<form role=group >
									...
									<div class="col-12"><br>
										<div class="form-group">
										<button class="btn btn-primary" id="insCorbar" >
										<span class="glyphicon glyphicon-ok"></span> Aplicar
										</button>
										</div>
									</div>	
						  ...
						  <div class="card-block">
							...
							<p class="card-text">Insira nova cor dos Menu laterais.</p>
								...
								<form role=group >
									...
									<div class="col-12"><br>
										<div class="form-group">
										<button class="btn btn-primary" id="aplCorMenuLat" >
										<span class="glyphicon glyphicon-ok"></span> Aplicar
										</button>
										</div>
									</div>	
					...
					<div class="panel-heading"><h3>Alterar cor do Rodapé</h3></div>
						<div class="panel-body">
							<form role=group >
								...
								<div class="col-md-3  col-sm-12 col-xs-12">
									<div class="form-group">
									<button class="btn btn-primary" id="insBaseCor" >
									<span class="glyphicon glyphicon-ok"></span> Aplicar
									</button>
									</div>
								</div>	
					...
					<div class="panel-heading"><h3>Alterar cor dos Paineis</h3></div>
						<div class="panel-body">
							<form role=group >
								...
								<div class="col-md-3  col-sm-12 col-xs-12">
									<div class="form-group">
									<button class="btn btn-primary" id="mudaPainel" >
									<span class="glyphicon glyphicon-ok"></span> Aplicar
									</button>
									</div>
								</div>	
