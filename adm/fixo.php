...
<div style="height:20px" class="visible-xs"></div>
        ...
        <div class="panel-heading"><h3>Fixo da Capa</h3></div>
    ...
    <form role="form" action="fixo_ins.php" enctype="multipart/form-data" method="post">
    
    
        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8 form-group" style="border:0px #000 dashed;">
                
                <p>Baner Fixo da Capa - Tamanho: 820 x 144 px</p>
		...
		<?php 
                $categori2 ="SELECT * FROM `bannerfixo`";
...
<div class="panel panel-<?php echo $corPainel; ?>">
				...
				<div class="panel-heading"><h3>Imagem do Banner</h3></div>

				 <div class="panel-body">
<?php 
											$categori ="SELECT * FROM `bannerfixo`";
									...
									?>		
			<div class="col-md-10  col-lg-10 col-sm-10 col-xs-10" style="margin-top:20px">
