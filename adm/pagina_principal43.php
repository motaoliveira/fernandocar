...
<div class="jumbotron" style="border-bottom:4px solid rgba(216,211,211,0.90);margin-top:-20px;background-color:<?php echo $corMenu; ?>;padding:0px;">
...
<div class="row">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="border:0px rgba(120,120,120,1.00) solid;height:120px;margin-left:auto;margin-right:auto"> <a href="sair.php" class="btn btn-small btn-default btn-xs" style="float:right;">x</a></div>
	...
	<div class="row">
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			...
			<div class="collapse" id="collapseprodutos">
							<a class="btn btn-block btn-default" id="menuCategoria" style="margin-top:5px;">Configurar</a>
							<a class="btn btn-block btn-default" id="menuFamilia">Inserir</a>
							<a class="btn btn-block btn-default" id="menuProd">Editar</a>
			</div>
		...
		<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9" id="conteudoAdm" style="background-color:rgba(233,233,233,0.1);border:0px dashed rgba(0,0,0,0.05);padding:2px">
		</div>
	</div>	
</div>
