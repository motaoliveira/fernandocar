<?php
	...
	@$id = $_POST['id'];
	if(@$_POST){
	mysql_query("UPDATE `edicao` SET `projeto` = '$id' WHERE `edicao`.`id` = 1;"); }
	else{
	//echo "carregue a id ";	
...
<?php
	...
	$sq = "SELECT * FROM `projeto` WHERE `id`=$atuacaoId";
		$quer = mysql_query($sq);
...
?>              
    <div class="row">         
     <div class="col">
	  <img class="img-fluid" src="../projeto/<?php echo $id_db; ?>/img/<?php echo $img_db; ?>" />
	</div>
    ...
    <form role="form" action="projeto_update.php" enctype="multipart/form-data" method="post">
    
    <div class="col form-group" style="border:0px #000 dashed;">
	...
	<div class="col ">
        ...
        <br />
            <input class="form-control theme-secondary" type="galery" id="galery"  placeholder="Link da Galeria" name="galery" value="<?php echo $galery_db; ?>">
